					...
					for (int col = array_col * operands_per_row; col < M && col < operands_per_row * (array_col + 1);
                        ...
                        if (weights[col * K + row] < 0) //if weight1 is negative
                        {
                            ...
                            for (int b = 0; b < (cells); b++) {  //Assume cells*colmux=colsize
                                ...
                                cnt++;
                                if(unlikely((cnt)%(col_size/writeDriverMuxed) == 0))
                                {

                                    for (int b1 = cnt - (col_size/writeDriverMuxed); b1 < cnt; ++b1) {
                                        static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeLatencyLTP = maxLatencyLTP;
                                        static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeLatencyLTD = maxLatencyLTD;
                                        if(weightChangeBatch){
                                            if (static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->nonIdenticalPulse) {	// Non-identical write pulse scheme
                                                if (static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->numPulse > 0) {	// LTP
                                                    static_cast<eNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageLTP = sqrt(static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageSquareSum / static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->numPulse);	// RMS value of LTP write voltage
                                                    static_cast<eNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageLTD = static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VinitLTD + 0.5 * static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VstepLTD * static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->maxNumLevelLTD;	// Use average voltage of LTD write voltage
                                                } else if (static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->numPulse < 0) {	// LTD
                                                    static_cast<eNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageLTP = static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VinitLTP + 0.5 * static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VstepLTP * static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->maxNumLevelLTP;    // Use average voltage of LTP write voltage
                                                    static_cast<eNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageLTD = sqrt(static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageSquareSum / (-1*static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->numPulse));    // RMS value of LTD write voltage
                                        ...
                                        static_cast<AnalogNVM*>(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->WriteEnergyCalculation(mn[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->wireCapCol);
                                    ...
                                    if(array_col == 0)
                                        ...
                                        latencyTemp += (maxLatencyLTP + maxLatencyLTD);
                                        if(latencyTemp  > wLatency[row])
                                            wLatency[row] = latencyTemp;
                                    }

                                	    weightChangeBatch = false;
                                        maxLatencyLTP = 0;
                                        maxLatencyLTD = 0;
                                }
...
#pragma omp critical
                            ...
                            for (int b = 0; b < (cells); b++) {
                                ...
                                if(unlikely((cnt)%(col_size/writeDriverMuxed) == 0))
                                {
                                    ...
                                    for (int b1 = cnt - (col_size/writeDriverMuxed); b1 < cnt; ++b1) {
                                        static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeLatencyLTP = maxLatencyLTP;
                                        static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeLatencyLTD = maxLatencyLTD;
                                        if(weightChangeBatch){
                                            if (static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->nonIdenticalPulse) {	// Non-identical write pulse scheme
                                                if (static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->numPulse > 0) {	// LTP
                                                    static_cast<eNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageLTP = sqrt(static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageSquareSum / static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->numPulse);	// RMS value of LTP write voltage
                                                    static_cast<eNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageLTD = static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VinitLTD + 0.5 * static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VstepLTD * static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->maxNumLevelLTD;	// Use average voltage of LTD write voltage
                                                } else if (static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->numPulse < 0) {	// LTD
                                                    static_cast<eNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageLTP = static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VinitLTP + 0.5 * static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VstepLTP * static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->maxNumLevelLTP;    // Use average voltage of LTP write voltage
                                                    static_cast<eNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageLTD = sqrt(static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageSquareSum / (-1*static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->numPulse));    // RMS value of LTD write voltage
                                                } else {	// Half-selected during LTP and LTD phases
                                                    static_cast<eNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageLTP = static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VinitLTP + 0.5 * static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VstepLTP * static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->maxNumLevelLTP;    // Use average voltage of LTP write voltage
                                                    static_cast<eNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->writeVoltageLTD = static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VinitLTD + 0.5 * static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->VstepLTD * static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->maxNumLevelLTD;    // Use average voltage of LTD write voltage
                                                }
                                        ...
                                        static_cast<AnalogNVM*>(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->cell[row - array_row * row_size][b1])->WriteEnergyCalculation(mp[(int)(array_row * ceil((double)M/operands_per_row)) + array_col]->wireCapCol);
					...
					for (int col = array_col * operands_per_row; col < M && col < operands_per_row * (array_col + 1); col++) {
                        ...
                        if (weights[row * M + col] < 0) //if weight1 is negative
                        {
                            ...
                            for (int b = 0; b < (cells); b++) {
                                ...
                                cSum += currentDictionary[(weight_mantissas[row * M + col]
                                                >> (24-(b+1)*bits)) & ((int)pow(2,bits)-1)];
                                cSum += currentDictionary[0];

                                opSumNegative += currentDictionary[(weight_mantissas[row * M + col]
                                                >> (24-(b+1)*bits)) & ((int)pow(2,bits)-1)] * (1<<(bits * ((cells-1) - b)));
...
#pragma omp critical
                            {
                                currentSum[row * M + col] += cSum;

                                operandsSumNegative[row * M + col] += opSumNegative;
                                operandsSumPositive[row * M + col] += opSumPositive;
                            }
                            ...
                            for (int b = 0; b < (cells); b++) {
                                ...
                                opSumPositive += currentDictionary[(weight_mantissas[row * M + col]
                                                >> (24-(b+1)*bits)) & ((int)pow(2,bits)-1)] * (1<<(bits * ((cells-1) - b)));
...
template<class memoryType>
void Memristor_CU<memoryType>::memristor_mm(const float *input, uint64_t dims, float *C, float alpha, float beta, uint32_t pulses)
{
    ...
    Array tp(1,1,100);
    tp.Initialization<memoryType>();
    tp.WriteCell(0,0,-(maxWeight - minWeight) ,0,maxWeight,minWeight,true);
    tp.WriteCell(0,0,0,0,maxWeight,minWeight,true);
    double ip_sum = 0;
    for (int b = 0; b < (cells); b++) {
        ip_sum +=  tp.GetMinCellReadCurrent(0,0) * (1<<(bits * ((cells-1) - b)));
    }
	if(ot == WMI)
	{
		...
		for (uint64_t row = 0; row < K; row++) {
			for (uint64_t col = 0; col < dims; col++) {
                ...
                //input_mantissas[row * dims + col] &= mask;
			}
		}

        for (uint64_t ii = 0; ii < am; ii++) {
            for (uint64_t jj = 0; jj < ak; jj++) {
                double readVoltage = static_cast<eNVM*>(tp.cell[0][0])->readVoltage;
                double readPulseWidth =	static_cast<eNVM*>(tp.cell[0][0])->readPulseWidth;
...
//											if ((input_mantissas[i_row * dims + i_col] >> n) & 1) {
                                    ...
                                    inputSum += input_mantissas[i_row * dims + i_col]*ip_sum;
                                    ...
                                    inputSum_negative += input_mantissas[i_row * dims + i_col]*ip_sum;
...
//											}
                                ...
                                IsumMax += tp.GetMaxCellReadCurrent(0, 0);
                                IsumMin += tp.GetMinCellReadCurrent(0, 0);
                            }
...
//                        }
                        ...
                        if (jj == 0) {
                            ...
                            if(beta == 0.)
                                C[w_col * dims + i_col] = alpha * dot_product_sum * pow(2, maxExponent[i_col] + maxExponentA[jj][w_col] - (254+(cells*bits-1)+23)/*300*/);
                            else
			            ...
			            if(get_exponent(CC[w_col *dims + i_col]) == 255){
                        	...
                        	cblas_sgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, M, dims, K, 1., A, K, input,
	                            dims, 0., EE, dims);
                            printf("jj = %d  dot_product_sum_positive = %d  dot_product_sum_negative = %d  maxExponent = %d maxExponentA=%d  dot_product_sum = %d  M = %ld K = %ld N = %ld   result = %.4e  hex = %x  cb = %d  exponent = %d  result=%llu ",
                                   jj,dot_product_sum+dot_product_sum_negative,dot_product_sum_negative,maxExponent[i_col], maxExponentA[jj][w_col], dot_product_sum, M, K, dims,
                                   EE[w_col*dims+i_col],
                                   *reinterpret_cast<unsigned int*>(&EE[w_col*dims+i_col]),cells*bits-1,
                                   maxExponent[i_col] + maxExponentA[jj][w_col] - (254+(cells*bits-1)+23),
                                   *reinterpret_cast<uint32_t*>(&(C[w_col * dims + i_col]) ));
...
//                                        if ((input_mantissas[i_row * K + i_col] >> n) & 1) { i_col,w_col
                                            ...
                                            Isum += input_mantissas[i_row * K + i_col]*operandsSumPositive[i_col * M + w_col]; //row:i_col
                                            inputSum += input_mantissas[i_row * K + i_col]*ip_sum;

                                            Isum_negative += input_mantissas[i_row * K + i_col]*operandsSumNegative[i_col * M + w_col]; //row:i_col

                                            inputSum_negative += input_mantissas[i_row * K + i_col]*ip_sum;
...
template<class memoryType>
void Memristor_CU<memoryType>::ReadLatency(uint32_t pulses)
{
    ...
    for (int w_col = 0; w_col < operand_per_row*cells; w_col+=numBatchReadSynapse) {
        SubarrayReadLatency += 2*NeuroSimSubArrayReadLatency(subArrays[0])*pulses/24;
        SubarrayReadLatency += 2*NeuroSimNeuronReadLatency(subArrays[0], adder[0], mux[0], muxDecoder[0], dff[0], subtractor[0])*pulses/24;
...
template<class memoryType>
void Memristor_CU<memoryType>::fast_mapping(const float *weights){
    ...
    Array *tp = new Array(1,1<<bits,100);
    tp->Initialization<memoryType>();
    double tmp_min = tp->GetMinCellReadCurrent(0,0), tmp_max = tp->GetMaxCellReadCurrent(0,0);
    double *currentDictionary = new double[1<<bits];
